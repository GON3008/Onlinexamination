...
def admin_content_view(request):
    return render(request,'exam/admin_content.html')
...
def admin_add_content_view(request):
    ...
    return render(request,'exam/admin_add_content.html',{'contentForm':contentForm})

@login_required(login_url='adminlogin')
def admin_view_content_view(request):
    contents = models.Content.objects.all()
    return render(request,'exam/admin_view_content.html',{'contents':contents})
